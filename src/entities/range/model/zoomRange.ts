 ...
 */
import { clampRange, clampValue, sanitizeMinRange } from "./clampRange";
import type { Range, RangeConstraints } from "./types";

/** Zoom 방향. Wheel deltaY → 방향 매핑(deltaY < 0 = "in")은 React 계층의 몫 */
 ...
 *
 * - anchor: 고정할 Position(포인터 중심 Zoom). 생략·NaN이면 Window 중앙 고정, 창 밖 값은 가장자리로 clamp — "anchor의 창 내 비율"이 줌 전후에 유지된다
